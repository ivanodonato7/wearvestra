...
/**
 * Product catalog the stylist can dress from.
 * LIMITATION: 20 SKUs across 3 fictional retailers, shared across genders
 * (no separate him/her catalogs). Under ~50 items/gender — visual repetition
 * is inevitable until this list grows with real product assets.
 */
const CATALOG = {
...
const STORE_DIRECTORY = [
  ...
  { id: "etsy", name: "Etsy", tier: "marketplace", url: (q) => `https://www.etsy.com/search?q=${qenc(q)}` },
  ...
  { id: "aliexpress", name: "AliExpress", tier: "marketplace", url: (q) => `https://www.aliexpress.com/wholesale?SearchText=${qenc(q)}` },
  ...
  // ---- Budget / fast fashion ----
  { id: "shein", name: "SHEIN", tier: "budget", url: (q) => `https://www.shein.com/pdsearch/${qenc(q)}/` },
  { id: "temu", name: "Temu", tier: "budget", url: (q) => `https://www.temu.com/search_result.html?search_key=${qenc(q)}` },
  { id: "romwe", name: "ROMWE", tier: "budget", url: (q) => `https://www.romwe.com/pdsearch/${qenc(q)}/` },
  { id: "zaful", name: "Zaful", tier: "budget", url: (q) => `https://www.zaful.com/search?q=${qenc(q)}` },
  { id: "fashionnova", name: "Fashion Nova", tier: "budget", url: (q) => `https://www.fashionnova.com/search?q=${qenc(q)}` },
  { id: "plt", name: "PrettyLittleThing", tier: "budget", url: (q) => `https://www.prettylittlething.us/catalogsearch/result/?q=${qenc(q)}` },
  { id: "boohoo", name: "Boohoo", tier: "budget", url: (q) => `https://us.boohoo.com/search/${qenc(q)}` },
  { id: "missguided", name: "Missguided", tier: "budget", url: (q) => `https://www.missguided.com/us/search?q=${qenc(q)}` },
  { id: "forever21", name: "Forever 21", tier: "budget", url: (q) => `https://www.forever21.com/us/search?q=${qenc(q)}` },
  { id: "cider", name: "Cider", tier: "budget", url: (q) => `https://www.shopcider.com/search?q=${qenc(q)}` },
  { id: "princesspolly", name: "Princess Polly", tier: "budget", url: (q) => `https://us.princesspolly.com/search?q=${qenc(q)}` },
  { id: "dollskill", name: "Dolls Kill", tier: "budget", url: (q) => `https://www.dollskill.com/search?q=${qenc(q)}` },
  { id: "nastygal", name: "Nasty Gal", tier: "budget", url: (q) => `https://www.nastygal.com/search/?q=${qenc(q)}` },
  { id: "whitefox", name: "White Fox", tier: "budget", url: (q) => `https://whitefoxboutique.com/search?q=${qenc(q)}` },
  { id: "edgeclothing", name: "Edge Clothing", tier: "budget", url: (q) => `https://www.edgeclothing.com/search?q=${qenc(q)}` },
  { id: "meshki", name: "Meshki", tier: "budget", url: (q) => `https://www.meshki.us/search?q=${qenc(q)}` },
  { id: "beginningboutique", name: "Beginning Boutique", tier: "budget", url: (q) => `https://www.beginningboutique.com/search?q=${qenc(q)}` },
  { id: "showpo", name: "Showpo", tier: "budget", url: (q) => `https://www.showpo.com/search?q=${qenc(q)}` },
  { id: "ohpolly", name: "Oh Polly", tier: "budget", url: (q) => `https://www.ohpolly.com/search?q=${qenc(q)}` },
  { id: "glassons", name: "Glassons", tier: "budget", url: (q) => `https://www.glassons.com/search?q=${qenc(q)}` },
  { id: "cottonon", name: "Cotton On", tier: "budget", url: (q) => `https://cottonon.com/US/search/?q=${qenc(q)}` },
  { id: "garage", name: "Garage", tier: "budget", url: (q) => `https://www.garageclothing.com/us/search?q=${qenc(q)}` },
  ...
  { id: "hm", name: "H&M", tier: "highstreet", url: (q) => `https://www2.hm.com/en_us/search-results.html?q=${qenc(q)}` },
  { id: "zara", name: "Zara", tier: "highstreet", url: (q) => `https://www.zara.com/us/en/search?searchTerm=${qenc(q)}` },
  { id: "uniqlo", name: "Uniqlo", tier: "highstreet", url: (q) => `https://www.uniqlo.com/us/en/search?q=${qenc(q)}` },
  { id: "asos", name: "ASOS", tier: "highstreet", url: (q) => `https://www.asos.com/us/search/?q=${qenc(q)}` },
  { id: "mango", name: "Mango", tier: "highstreet", url: (q) => `https://shop.mango.com/us/en/search?kw=${qenc(q)}` },
  { id: "gap", name: "Gap", tier: "highstreet", url: (q) => `https://www.gap.com/browse/search.do?searchText=${qenc(q)}` },
  { id: "oldnavy", name: "Old Navy", tier: "highstreet", url: (q) => `https://oldnavy.gap.com/browse/search.do?searchText=${qenc(q)}` },
  ...
  { id: "athleta", name: "Athleta", tier: "highstreet", url: (q) => `https://athleta.gap.com/browse/search.do?searchText=${qenc(q)}` },
  { id: "express", name: "Express", tier: "highstreet", url: (q) => `https://www.express.com/clothing/search?q=${qenc(q)}` },
  ...
  { id: "aerie", name: "Aerie", tier: "highstreet", url: (q) => `https://www.ae.com/us/en/aerie/search?searchTerm=${qenc(q)}` },
  { id: "urban", name: "Urban Outfitters", tier: "highstreet", url: (q) => `https://www.urbanoutfitters.com/search?q=${qenc(q)}` },
  { id: "anthropologie", name: "Anthropologie", tier: "highstreet", url: (q) => `https://www.anthropologie.com/search?q=${qenc(q)}` },
  { id: "freepeople", name: "Free People", tier: "highstreet", url: (q) => `https://www.freepeople.com/search?q=${qenc(q)}` },
  { id: "madewell", name: "Madewell", tier: "highstreet", url: (q) => `https://www.madewell.com/search/?q=${qenc(q)}` },
  ...
  { id: "otherstories", name: "& Other Stories", tier: "highstreet", url: (q) => `https://www.stories.com/en-us/search/?q=${qenc(q)}` },
  ...
  { id: "stradivarius", name: "Stradivarius", tier: "highstreet", url: (q) => `https://www.stradivarius.com/us/search?q=${qenc(q)}` },
  { id: "topshop", name: "Topshop", tier: "highstreet", url: (q) => `https://www.asos.com/us/search/?q=${qenc(`topshop ${q}`)}` },
  ...
  { id: "alo", name: "Alo Yoga", tier: "highstreet", url: (q) => `https://www.aloyoga.com/search?q=${qenc(q)}` },
  ...
  { id: "aritzia", name: "Aritzia", tier: "highstreet", url: (q) => `https://www.aritzia.com/us/en/search?q=${qenc(q)}` },
  { id: "reformation", name: "Reformation", tier: "highstreet", url: (q) => `https://www.thereformation.com/search?q=${qenc(q)}` },
  ...
  { id: "famousfootwear", name: "Famous Footwear", tier: "highstreet", url: (q) => `https://www.famousfootwear.com/search?query=${qenc(q)}` },
  { id: "sunglasshut", name: "Sunglass Hut", tier: "highstreet", url: (q) => `https://www.sunglasshut.com/us/en-us/search?q=${qenc(q)}` },
  { id: "warbyparker", name: "Warby Parker", tier: "highstreet", url: (q) => `https://www.warbyparker.com/search?q=${qenc(q)}` },
  { id: "rayban", name: "Ray-Ban", tier: "highstreet", url: (q) => `https://www.ray-ban.com/usa/search?q=${qenc(q)}` },
  ...
  { id: "landsend", name: "Lands' End", tier: "highstreet", url: (q) => `https://www.landsend.com/shop/search/?Ntt=${qenc(q)}` },
  ...
  { id: "ugg", name: "UGG", tier: "highstreet", url: (q) => `https://www.ugg.com/search?q=${qenc(q)}` },
  { id: "birkenstock", name: "Birkenstock", tier: "highstreet", url: (q) => `https://www.birkenstock.com/us/search?q=${qenc(q)}` },
  { id: "crocs", name: "Crocs", tier: "highstreet", url: (q) => `https://www.crocs.com/search?q=${qenc(q)}` },
  { id: "skechers", name: "Skechers", tier: "highstreet", url: (q) => `https://www.skechers.com/search/?q=${qenc(q)}` },
  ...
  { id: "michaelkors", name: "Michael Kors", tier: "highstreet", url: (q) => `https://www.michaelkors.com/search/?q=${qenc(q)}` },
  { id: "coach", name: "Coach", tier: "highstreet", url: (q) => `https://www.coach.com/shop/search?q=${qenc(q)}` },
  { id: "katespade", name: "Kate Spade", tier: "highstreet", url: (q) => `https://www.katespade.com/search?q=${qenc(q)}` },
  { id: "toryburch", name: "Tory Burch", tier: "highstreet", url: (q) => `https://www.toryburch.com/en-us/search?q=${qenc(q)}` },
  { id: "hugoboss", name: "Hugo Boss", tier: "highstreet", url: (q) => `https://www.hugoboss.com/us/search?q=${qenc(q)}` },
  { id: "lacoste", name: "Lacoste", tier: "highstreet", url: (q) => `https://www.lacoste.com/us/lacoste/search/?q=${qenc(q)}` },
  { id: "brooksbrothers", name: "Brooks Brothers", tier: "highstreet", url: (q) => `https://www.brooksbrothers.com/search?q=${qenc(q)}` },
  ...
  { id: "revolve", name: "Revolve", tier: "premium", url: (q) => `https://www.revolve.com/r/Search.jsp?s=${qenc(q)}` },
  { id: "bloomingdales", name: "Bloomingdale's", tier: "premium", url: (q) => `https://www.bloomingdales.com/shop/search?keyword=${qenc(q)}` },
  { id: "neimanmarcus", name: "Neiman Marcus", tier: "premium", url: (q) => `https://www.neimanmarcus.com/search?q=${qenc(q)}` },
  { id: "shopbop", name: "Shopbop", tier: "premium", url: (q) => `https://www.shopbop.com/s?keywords=${qenc(q)}` },
  { id: "intermix", name: "Intermix", tier: "premium", url: (q) => `https://www.intermixonline.com/search?q=${qenc(q)}` },
  { id: "fwrd", name: "FWD", tier: "premium", url: (q) => `https://www.fwrd.com/fw/search/?s=${qenc(q)}` },
  { id: "modaoperandi", name: "Moda Operandi", tier: "premium", url: (q) => `https://www.modaoperandi.com/search?q=${qenc(q)}` },
  { id: "mytheresa", name: "Mytheresa", tier: "premium", url: (q) => `https://www.mytheresa.com/us/en/search?q=${qenc(q)}` },
  { id: "luisaviaroma", name: "Luisaviaroma", tier: "premium", url: (q) => `https://www.luisaviaroma.com/en-us/shop/search?Text=${qenc(q)}` },
  ...
  { id: "harrods", name: "Harrods", tier: "premium", url: (q) => `https://www.harrods.com/en-us/search?text=${qenc(q)}` },
  { id: "browns", name: "Browns", tier: "premium", url: (q) => `https://www.brownsfashion.com/us/search?q=${qenc(q)}` },
  ...
  { id: "ted_me_and_em", name: "Me+Em", tier: "premium", url: (q) => `https://www.meandem.com/search?q=${qenc(q)}` },
  { id: "sezane", name: "Sézane", tier: "premium", url: (q) => `https://www.sezane.com/us/search?q=${qenc(q)}` },
  { id: "rouje", name: "Rouje", tier: "premium", url: (q) => `https://www.rouje.com/us/search?q=${qenc(q)}` },
  { id: "toteme", name: "Toteme", tier: "premium", url: (q) => `https://toteme.com/search?q=${qenc(q)}` },
  { id: "ganni", name: "Ganni", tier: "premium", url: (q) => `https://www.ganni.com/en-us/search?q=${qenc(q)}` },
  ...
  { id: "sandro", name: "Sandro", tier: "premium", url: (q) => `https://us.sandro-paris.com/search?q=${qenc(q)}` },
  { id: "maje", name: "Maje", tier: "premium", url: (q) => `https://us.maje.com/search?q=${qenc(q)}` },
  { id: "anddaughter", name: "&Daughter", tier: "premium", url: (q) => `https://www.and-daughter.com/search?q=${qenc(q)}` },
  { id: "frame", name: "Frame", tier: "premium", url: (q) => `https://frame-store.com/search?q=${qenc(q)}` },
  { id: "reiss_alt", name: "Whistles", tier: "premium", url: (q) => `https://www.whistles.com/search?q=${qenc(q)}` },
  { id: "jigsaw", name: "Jigsaw", tier: "premium", url: (q) => `https://www.jigsaw-online.com/search?q=${qenc(q)}` },
  { id: "karenmillen", name: "Karen Millen", tier: "premium", url: (q) => `https://www.karenmillen.com/us/search/?q=${qenc(q)}` },
  { id: "phaseeight", name: "Phase Eight", tier: "premium", url: (q) => `https://www.phase-eight.com/search?q=${qenc(q)}` },
  ...
  { id: "mother", name: "MOTHER", tier: "premium", url: (q) => `https://www.motherdenim.com/search?q=${qenc(q)}` },
  { id: "golden_goose", name: "Golden Goose", tier: "premium", url: (q) => `https://www.goldengoose.com/us/en/search?q=${qenc(q)}` },
  ...
  { id: "rothys", name: "Rothy's", tier: "premium", url: (q) => `https://rothys.com/search?q=${qenc(q)}` },

  // ---- Luxury ----
  { id: "ssense", name: "SSENSE", tier: "luxury", url: (q) => `https://www.ssense.com/en-us/search?q=${qenc(q)}` },
  { id: "mrporter", name: "Mr Porter", tier: "luxury", url: (q) => `https://www.mrporter.com/en-us/mens/search?q=${qenc(q)}` },
  { id: "netaporter", name: "Net-a-Porter", tier: "luxury", url: (q) => `https://www.net-a-porter.com/en-us/shop/search?q=${qenc(q)}` },
  { id: "farfetch", name: "Farfetch", tier: "luxury", url: (q) => `https://www.farfetch.com/shopping/search/items.aspx?q=${qenc(q)}` },
  { id: "saks", name: "Saks", tier: "luxury", url: (q) => `https://www.saksfifthavenue.com/search?text=${qenc(q)}` },
  { id: "matches", name: "Matches", tier: "luxury", url: (q) => `https://www.matchesfashion.com/us/search?q=${qenc(q)}` },
  { id: "bergdorf", name: "Bergdorf Goodman", tier: "luxury", url: (q) => `https://www.bergdorfgoodman.com/search?q=${qenc(q)}` },
  { id: "theoutnet", name: "The Outnet", tier: "luxury", url: (q) => `https://www.theoutnet.com/en-us/shop/search?q=${qenc(q)}` },
  { id: "yoox", name: "YOOX", tier: "luxury", url: (q) => `https://www.yoox.com/us/searchResult?q=${qenc(q)}` },
  { id: "twentyfour_s", name: "24S", tier: "luxury", url: (q) => `https://www.24s.com/en-us/search?q=${qenc(q)}` },
  ...
  { id: "chanel", name: "Chanel", tier: "luxury", url: (q) => `https://www.chanel.com/us/search/?q=${qenc(q)}` },
  { id: "hermes", name: "Hermès", tier: "luxury", url: (q) => `https://www.hermes.com/us/en/search/?s=${qenc(q)}` },
  { id: "fendi", name: "Fendi", tier: "luxury", url: (q) => `https://www.fendi.com/us-en/search?q=${qenc(q)}` },
  ...
  { id: "celine", name: "Celine", tier: "luxury", url: (q) => `https://www.celine.com/en-us/search?q=${qenc(q)}` },
  { id: "loewe", name: "Loewe", tier: "luxury", url: (q) => `https://www.loewe.com/usa/en/search?q=${qenc(q)}` },
  ...
  { id: "maxmara", name: "Max Mara", tier: "luxury", url: (q) => `https://us.maxmara.com/search?q=${qenc(q)}` },
  ...
  { id: "therow", name: "The Row", tier: "luxury", url: (q) => `https://www.therow.com/search?q=${qenc(q)}` },
  { id: "khaite", name: "Khaite", tier: "luxury", url: (q) => `https://www.khaite.com/search?q=${qenc(q)}` },
  { id: "lemaire", name: "Lemaire", tier: "luxury", url: (q) => `https://www.lemaire.fr/search?q=${qenc(q)}` },
  { id: "isabelmarant", name: "Isabel Marant", tier: "luxury", url: (q) => `https://www.isabelmarant.com/us/search?q=${qenc(q)}` },
  { id: "stellamccartney", name: "Stella McCartney", tier: "luxury", url: (q) => `https://www.stellamccartney.com/us/en/search?q=${qenc(q)}` },
  ...
  { id: "poshmark", name: "Poshmark", tier: "outlet", url: (q) => `https://poshmark.com/search?query=${qenc(q)}` },
  { id: "depop", name: "Depop", tier: "outlet", url: (q) => `https://www.depop.com/search/?q=${qenc(q)}` },
  { id: "thredup", name: "ThredUp", tier: "outlet", url: (q) => `https://www.thredup.com/products?text=${qenc(q)}` },
  ...
  { id: "facebook_mp", name: "Facebook Marketplace", tier: "outlet", url: (q) => `https://www.facebook.com/marketplace/search/?query=${qenc(q)}` },
  { id: "mercari", name: "Mercari", tier: "outlet", url: (q) => `https://www.mercari.com/search/?keyword=${qenc(q)}` },
  { id: "offerup", name: "OfferUp", tier: "outlet", url: (q) => `https://offerup.com/search/?q=${qenc(q)}` },
  ...
  { id: "oldnavyoutlet", name: "Old Navy Outlet", tier: "outlet", url: (q) => `https://oldnavy.gap.com/browse/search.do?searchText=${qenc(q)}` },
];
...
const OUTFIT_RECIPES = [
  ...
  // --- Extra occasion / silhouette range (same 20 SKUs, different combos) ---
  {
  ...
  {
    id: "interview-sharp",
    outer: "blazerNavy", top: "shirt", bottom: "trouserNavy", shoe: "shoeBlack", acc: "beltAlt",
    occasions: ["work", "interview", "office", "meeting"],
    vibe: ["classy", "modern", "polished", "quiet"],
    styleFamily: "classy",
    archetypes: ["Quiet Tailored", "Classic Polished", "Modern Sharp", "Minimal Directional"],
    lifestyles: ["Office / client-facing", "Student life", "On the move — travel, events, varied"],
    structure: "tailored",
  },
  {
    id: "first-date-open",
    outer: null, top: "shirt", bottom: "trouserAlt", shoe: "shoeAlt", acc: "scarfBurgundy",
    occasions: ["dinner", "date", "evening", "sexy"],
    vibe: ["romantic", "sexy", "warm", "relaxed"],
    styleFamily: "romantic",
    archetypes: ["Romantic Soft", "Sexy Evening", "Warm Layered", "Relaxed Considered"],
    lifestyles: ["Creative or flexible workplace", "Remote, mostly at home", "On the move — travel, events, varied"],
    structure: "relaxed",
  },
  {
  ...
  {
    id: "brunch-open-sun",
    outer: null, top: "shirt", bottom: "trouserAlt", shoe: "shoe", acc: "sunglasses",
    occasions: ["weekend", "brunch", "casual", "everyday"],
    vibe: ["relaxed", "warm", "romantic", "minimal"],
    styleFamily: "relaxed",
    archetypes: ["Relaxed Considered", "Warm Layered", "Romantic Soft", "Minimal Directional"],
    lifestyles: ["Remote, mostly at home", "Creative or flexible workplace", "Student life"],
    structure: "relaxed",
  },
  {
    id: "cocktail-black",
    outer: "blazerBlack", top: "shirt", bottom: "trouserBlack", shoe: "shoeBlack", acc: "scarfBurgundy",
    occasions: ["event", "cocktail", "evening", "dinner", "celebration"],
    vibe: ["classy", "sexy", "polished", "bold"],
    styleFamily: "classy",
    archetypes: ["Classic Polished", "Sexy Evening", "Quiet Tailored", "Bold Expressive"],
    lifestyles: ["On the move — travel, events, varied", "Office / client-facing", "Creative or flexible workplace"],
    structure: "tailored",
  },
  {
    id: "airport-layers",
    outer: "blazerAlt", top: "shirtAlt", bottom: "trouserAlt", shoe: "shoeAlt", acc: "sunglasses",
    occasions: ["travel", "airport", "weekend", "everyday"],
    vibe: ["relaxed", "modern", "warm", "street"],
    styleFamily: "relaxed",
    archetypes: ["Relaxed Considered", "Modern Sharp", "Warm Layered", "Streetwear Cool"],
    lifestyles: ["On the move — travel, events, varied", "Remote, mostly at home", "Creative or flexible workplace"],
    structure: "relaxed",
  },
  {
    id: "look-good-tonight",
    outer: "blazerNavy", top: "shirtAlt", bottom: "trouserNavy", shoe: "shoeBlack", acc: "belt",
    occasions: ["dinner", "evening", "date", "everyday", "event"],
    vibe: ["modern", "classy", "polished", "sexy"],
    styleFamily: "modern",
    archetypes: ["Modern Sharp", "Quiet Tailored", "Classic Polished", "Sexy Evening"],
    lifestyles: ["Office / client-facing", "Creative or flexible workplace", "On the move — travel, events, varied"],
    structure: "structured",
  },
];
...
const OCCASION_KEYWORDS = [
  { id: "wedding", keys: ["wedding", "wedding guest", "black tie", "ceremony", "boda", "mariage", "gala"] },
  { id: "dinner", keys: ["dinner", "date night", "first date", "evening", "restaurant", "cena", "dîner", "tonight", "primera cita", "premier rendez"] },
  { id: "work", keys: ["work", "office", "meeting", "client", "interview", "job interview", "entrevista", "trabajo", "bureau", "réunion", "work dinner", "cena de trabajo", "dîner professionnel"] },
  { id: "travel", keys: ["travel", "airport", "trip", "flight", "viaje", "voyage", "avion"] },
  { id: "weekend", keys: ["weekend", "casual", "brunch", "fin de semana", "week-end", "nothing fussy", "sin complicaciones", "sans prise"] },
  { id: "event", keys: ["event", "party", "celebration", "cocktail", "evento", "fête", "soirée"] },
  { id: "everyday", keys: ["everyday", "daily", "help me look", "look good", "diario", "quotidien", "no idea"] },
  { id: "street", keys: ["streetwear", "street", "urban", "hype", "sneaker", "urbano"] },
  { id: "sexy", keys: ["sexy", "seductive", "club", "night out", "noche", "soirée sexy"] },
  { id: "active", keys: ["gym", "workout", "athletic", "running", "sport", "ejercicio", "sportif", "active"] },
  { id: "formal", keys: ["formal", "formel", "black tie"] },
];
...
const STYLE_MOOD_KEYWORDS = [
  ...
  { id: "sexy", keys: ["sexy", "seductive", "alluring", "night out", "date night", "sensual", "noche sexy"] },
  { id: "modern", keys: ["modern", "contemporary", "sharp", "sleek", "clean modern", "moderno", "moderne", "affûté"] },
  { id: "edgy", keys: ["edgy", "attitude", "rebel", "grunge soft"] },
  { id: "romantic", keys: ["romantic", "dreamy", "delicate", "romántico", "romantique"] },
  { id: "minimal", keys: ["minimal", "simple", "quiet luxury", "minimalista", "minimaliste"] },
...
/** Phrase or whole-word match — avoids "brunch"→run, "update"→date, "informal"→formal. */
function textHasKeyword(lower, key) {
  const k = String(key || "").toLowerCase().trim();
  if (!k || !lower) return false;
...
function detectOccasions(text) {
  ...
  for (const row of OCCASION_KEYWORDS) {
    if (row.keys.some((k) => textHasKeyword(lower, k))) hits.push(row.id);
  }
  // Whole-word "date" only (not update/candidate/validate)
  if (!hits.includes("dinner") && /(?:^|[^a-zà-ÿ0-9])date(?:$|[^a-zà-ÿ0-9])/i.test(lower)) {
    hits.push("dinner");
  }
  // Whole-word "run" for gym (not brunch)
  if (!hits.includes("active") && /(?:^|[^a-zà-ÿ0-9])run(?:ning)?(?:$|[^a-zà-ÿ0-9])/i.test(lower)) {
    hits.push("active");
  }
  return [...new Set(hits)];
}
...
function resolveHeroOccasionSlug({ occasion, styleFamily, occasions = [], prompt = "" } = {}) {
  ...
  if (/\b(casual|weekend|everyday|street|travel|work|office|modern|minimal|relaxed|edgy|bold|classy|trip)\b/.test(tokens)
    || ["weekend", "everyday", "street", "travel", "work"].some((id) => occasions.includes(id))
...
/**
 * Light DNA adjustment on recipe keys.
 * Occasion / mood requests keep the recipe silhouette; profile only swaps
 * pieces that clash with avoid-colors (not a hard collapse to one palette look).
 */
function tuneItemsToProfile(itemKeys, profile, styleMoods = [], styleFamily = null, { occasionDriven = false } = {}) {
  ...
  // Only lock when the USER named this genre — not merely because the recipe has a styleFamily
  const genreLocked = moods.length > 0 && styleFamily
    && moods.includes(styleFamily)
    && ["streetwear", "sexy", "edgy", "classy", "modern", "romantic", "relaxed"].includes(styleFamily);

  // Occasion or user-named genre: keep recipe keys; only dodge avoided colors
  if (genreLocked || occasionDriven) {
    return itemKeys.map((key) => {
      if (!CATALOG[key]) return key;
      const tags = CATALOG[key].paletteTags || [];
      if (avoid.length && tags.some((t) => avoid.includes(t))) {
        const fam = familyOfKey(key);
        return fam ? bestVariantInFamily(fam, palette, avoid, null) : key;
      }
      return key;
    });
  }
  ...
  return itemKeys.map((key) => {
    ...
    // Soft DNA: prefer recipe key 50% of the time so looks don't all converge
    if (CATALOG[key] && (hashSeed(`${key}|${fam}|${(palette || []).join(",")}`) % 2 === 0)) {
      const tags = CATALOG[key].paletteTags || [];
      if (!(avoid.length && tags.some((t) => avoid.includes(t)))) return key;
    }
...
function buildRationale(recipe, occasionIds, lang, profile = {}) {
  ...
  const en = {
    wedding: hasBlazer
      ? `Wedding-guest formality first —${fitBit} tailored outer layer in ${colorHint || "a clean palette"}, crisp shirt, trousers that hold a line (nudged toward ${arch}).`
      : `Wedding-appropriate polish — elevated pieces in ${colorHint || "your colors"} without costume energy.`,
    dinner: `Dinner formality —${fitBit} evening-ready in ${colorHint || "your palette"}, finished so it reads intentional.`,
    work: hasBlazer
      ? `Work / interview formality —${fitBit} structured layers in ${colorHint || "your palette"}, client-ready.`
      : `Work-appropriate —${fitBit} elevated basics in ${colorHint || "your colors"} that still feel current.`,
    travel: `Travel-smart — pieces in ${colorHint || "your palette"} that move and still look put together.`,
    weekend: `Weekend ease —${fitBit} nothing fussy, relaxed intention in ${colorHint || "your colors"}.`,
    event: `Event polish —${fitBit} clear silhouette in ${colorHint || "your palette"} for celebration light.`,
    everyday: `Open brief (“look good”) —${fitBit} a versatile edit around ${colorHint || "your palette"}, nothing shouting.`,
    formal: `Formal without stiffness — occasion-led, with ${colorHint || "chosen"} colors.`,
    evening: `Evening polish — ${colorHint || "your palette"}, wearable in low light.`,
    casual: `Casual and easy — pieces in ${colorHint || "your colors"} with a clear silhouette.`,
    street: `Streetwear energy —${fitBit} looser attitude in ${colorHint || "your palette"}, sunglasses on.`,
    sexy: `Sexy evening read —${fitBit} darker lines in ${colorHint || "your colors"} that still feel wearable.`,
    classy: `Classy polish —${fitBit} clean structure in ${colorHint || "your palette"}.`,
    modern: `Modern & sharp —${fitBit} crisp shapes in ${colorHint || "your palette"}.`,
    edgy: `Edgy contemporary —${fitBit} contrast and attitude in ${colorHint || "your colors"}.`,
...
function composeOutfits(prompt, profile, lang = "en", count = 3, recentHistory = []) {
  stylistTurn += 1;
  ...
  const recentItems = new Set(
    (recentHistory || []).flatMap((h) => h.items || []),
  );
  const recentSils = new Set(
    (recentHistory || []).flatMap((h) => h.silhouettes || []),
  );
  const seed = hashSeed([
    prompt,
    styleMoods.join(","),
  ...
  const scored = OUTFIT_RECIPES.map((recipe, i) => {
    ...
    let score = (seed + i * 47) % 23; // stronger shuffle across turns

    // --- REQUEST FIRST: occasion + mood ---
    for (const o of recipe.occasions || []) {
      if (promptOccasions.includes(o)) score += 52;
      else if (profileOccasions.includes(o)) score += 6; // DNA occasion = light
      else if (occasions.includes(o)) score += 2;
    }
    if (styleMoods.length) {
      if (styleMoods.includes(recipe.styleFamily)) score += 50;
      for (const mood of styleMoods) {
        if ((recipe.vibe || []).includes(mood) || (recipe.vibe || []).includes(mood.replace("wear", ""))) score += 20;
        if (mood === "streetwear" && (recipe.vibe || []).includes("street")) score += 20;
        if (mood === "classy" && (recipe.vibe || []).some((v) => ["classy", "classic", "polished"].includes(v))) score += 16;
      }
      const clash = {
        streetwear: ["classy"],
      ...
      for (const mood of styleMoods) {
        if ((clash[mood] || []).includes(recipe.styleFamily)) score -= 18;
      }
    }
    ...
    if (promptOccasions.includes("work")) {
      if ((recipe.occasions || []).some((o) => ["work", "office", "interview", "meeting"].includes(o))) score += 20;
    }

    // --- Style DNA as LIGHT adjustment (not a hard filter) ---
    const recipeArch = (recipe.archetypes || []).map(normalizeArchetype);
    if (arch && recipeArch.includes(arch)) score += occasionDriven ? 8 : 18;
    else if (arch && recipeArch.some((a) => a.split(" ")[0] === arch.split(" ")[0])) score += occasionDriven ? 3 : 8;
    for (const v of recipe.vibe || []) {
      if (vibes.includes(v)) score += occasionDriven ? 3 : 6;
    }
    if (preferredFamilies.includes(recipe.styleFamily)) score += occasionDriven ? 3 : 8;

    const recipeLife = recipe.lifestyles || [];
    if (profile?.lifestyle && recipeLife.includes(profile.lifestyle)) score += occasionDriven ? 4 : 12;

    if (fit.structure && recipe.structure === fit.structure) score += occasionDriven ? 4 : 12;
    else if (fit.structure === "tailored" && recipe.structure === "structured") score += occasionDriven ? 2 : 8;
    else if (fit.structure && recipe.structure && fit.structure !== recipe.structure) {
      score -= occasionDriven ? 1 : 8;
    }

    if (fit.preferOuter === true && hasOuter) score += occasionDriven ? 2 : 6;
    if (fit.preferOuter === false && !hasOuter) score += occasionDriven ? 2 : 6;
    ...
    // --- Avoid repeating last 3–5 requests ---
    const sil = silhouetteKey(items, recipe);
    let recentHits = 0;
    for (const k of items) {
      if (recentItems.has(k)) recentHits += 1;
    }
    score -= recentHits * 16;
    if (recentSils.has(sil)) score -= 28;

    // --- Palette: soft preference, hard avoid only ---
    const paletteScore = outfitPaletteScore(items, palette, avoid);
    score += Math.min(occasionDriven ? 14 : 28, paletteScore);
    if (palette.length && !paletteWantsGreen(palette)) {
      score -= items.filter((k) => itemIsGreen(k)).length * 35;
    } else if (paletteWantsGreen(palette)) {
      score += items.filter((k) => itemIsGreen(k)).length * 10;
    }

    if (budget === "elevated" && hasOuter) score += 4;
    if (budget === "considered" && !hasOuter) score += 4;
    if (budget === "mixed") score += (seed + i) % 7;
    ...
    return { recipe, score, items, styleFamily: recipe.styleFamily || "modern", silhouette: sil };
  ...
  const tryTake = (row, mode, itemsOverride = null) => {
    ...
    const items = itemsOverride || row.items;
    const sig = outfitSignature(items);
    const core = items.filter((k) => !ACCESSORY_KEYS.has(k)).join("+");
    ...
    const sil = row.silhouette || silhouetteKey(items, row.recipe);
    picked.push({
  ...
  // Last resort: nudge accessory / outer to force a unique silhouette
  if (picked.length < count) {
    for (const row of scored) {
      if (picked.length >= count) break;
      if (usedRecipeIds.has(row.recipe.id)) continue;
      ...
      if (accPool.length) {
        const nextAcc = bestVariantInFamily(accPool[picked.length % accPool.length], palette, avoid, row.recipe.structure);
        if (accIdx >= 0) items[accIdx] = nextAcc;
        else items.push(nextAcc);
      } else if (picked.length % 2 === 1) {
      ...
      tryTake({ ...row, silhouette: silhouetteKey(items, row.recipe) }, "any", items);
    }
  }
  return picked;
}
 ...
 */
function composeWeekPlan(prompt, profile, lang = "en", recentHistory = []) {
  ...
  const avoid = profile?.avoid || [];
  const budget = profile?.budget || "balanced";
  const recentItems = new Set((recentHistory || []).flatMap((h) => h.items || []));
  const recentSils = new Set((recentHistory || []).flatMap((h) => h.silhouettes || []));
  const seed = hashSeed([
    workPrompt, arch, profile?.fit, profile?.lifestyle, budget,
    palette.join(","), (avoid || []).join(","), "weekplan", stylistTurn, String(Date.now() % 9973),
  ].join("|"));

  const scored = OUTFIT_RECIPES.map((recipe, i) => {
    let items = tuneItemsToProfile(recipeItems(recipe), profile, [], recipe.styleFamily, { occasionDriven: true });
    const sil = recipeSilhouette(recipe);
    let recentPenalty = 0;
    for (const k of items) {
      if (recentItems.has(k)) recentPenalty += 12;
    }
    if (recentSils.has(sil) || recentSils.has(silhouetteKey(items, recipe))) recentPenalty += 22;
    ...
    score -= recentPenalty;
    return { recipe, score, items, silhouette: sil, styleFamily: recipe.styleFamily };
  }).sort((a, b) => b.score - a.score);
...
function OutfitHero({ gender = "woman", occasion = "default", palette = [] }) {
  const { t } = useLang();
...
// ==================== OUTFIT CARD ====================
function OutfitCard({ outfit, onSwap, onSave, saved, modelGender, onModelGenderChange, favoriteStores, optionLabel, palette = [], avoid = [], audience = null, promptHint = "" }) {
...
// ==================== APP SCREENS ====================
/** English prompt text for home chips — always submit this so occasion matching is consistent across locales. */
const HOME_CHIP_PROMPTS = {
  chipStreetwear: "Streetwear vibes",
  chipClassy: "Classy & elegant",
  chipSexyNight: "Sexy night out",
  chipModernLook: "Modern & sharp",
  chipDressWedding: "Dress me for a wedding",
  chipWorkDinner: "Work dinner tonight",
  chipWeekendCasual: "Weekend, nothing fussy",
  chipWeekPlan: "Plan my week — 5 looks",
};

function HomeScreen({ profile, onPrompt, homeInput, setHomeInput }) {
  const { lang, t, tOpt } = useLang();
  const chipKeys = Object.keys(HOME_CHIP_PROMPTS);
  ...
  function fireChip(key) {
    const phrase = HOME_CHIP_PROMPTS[key] || t(key);
    if (!phrase || !onPrompt) return;
    onPrompt(phrase);
  }
  ...
  return (
    <div className="screen">
      ...
      <div className="chip-row" role="group" aria-label={t("askYourStylist")}>
        {chipKeys.map((k) => (
          <button
            key={k}
            type="button"
...
export default function VestraPrototype() {
  ...
  /** Last 3–5 stylist requests — item ids + silhouettes to avoid repeats (session). */
  const [recentLookHistory, setRecentLookHistory] = useState([]);

  const t = (key) => (UI[lang] && UI[lang][key]) || UI.en[key] || key;

  function rememberLooks(outfits) {
    if (!outfits?.length) return;
    const entry = {
      items: outfits.flatMap((o) => o.items || []),
      silhouettes: outfits.map((o) => o.silhouette || silhouetteKey(o.items || [])),
    };
    setRecentLookHistory((prev) => [...prev, entry].slice(-5));
  }
  ...
  async function sendMessage(text, profileOverride) {
    ...
    const primaryMood = styleMoods[0] || null;
    // Refining the same look → allow repeats; new request → avoid last 3–5
    const refiningSame = !!revision || /\b(refine|same look|try again|tweak this|another option|más opciones|autre option|riprova)\b/i.test(finalText);
    const historyForAvoid = refiningSame ? [] : recentLookHistory;
    ...
    const live = await fetchStylistLooks({
      ...
      avoidRecentItems: historyForAvoid.flatMap((h) => h.items || []),
      avoidSilhouettes: historyForAvoid.flatMap((h) => h.silhouettes || []),
    });
    if (live?.outfits?.length) {
      ...
      const outfits = live.outfits.map((o, i) => {
        ...
        const items = (o.items || []).filter((k) => CATALOG[k]);
        return {
          ...o,
          option: o.option || i + 1,
          ...
          styleFamily,
          items,
          silhouette: o.silhouette || silhouetteKey(items),
          rationale: humanizeRationale(o.rationale, lang),
          occasion: resolveHeroOccasionSlug({
            occasion: o.occasion,
            styleFamily,
            occasions: isWeek && i === 4 ? ["dinner", "sexy"] : promptOccasions,
            prompt: finalText,
          }),
        };
      }).filter((o) => o.items.length >= 3);
      const minCount = isWeek ? 5 : 3;
      // Reject partial live payloads so local composer can fill a full set
      if (outfits.length >= minCount) {
        ...
        setMessages((m) => [...m, {
          ...
          outfits: outfits.slice(0, minCount),
          shoppingList,
          weekPlan: isWeek,
    ...
    if (weekPlan) {
      const plan = composeWeekPlan(finalText, activeProfile, lang, historyForAvoid);
      rememberLooks(plan.outfits);
      setMessages((m) => [...m, {
        role: "assistant",
      ...
      const outfits = composeOutfits(finalText, activeProfile, lang, 3, historyForAvoid);
      rememberLooks(outfits);
      setMessages((m) => [...m, {
        role: "assistant",
  ...
  return (
    ...
    <div className="app-outer">
      <style>{`
        ...
        .outfit-hero-stock{ display:flex; flex-direction:column; background:#151513; border:1px solid #2a2a26; }
        .outfit-hero-stock .model-photo{
          width:100%; flex:1; min-height:0; object-fit:cover; object-position:center top; display:block;
          filter:saturate(0.92) contrast(1.02);
        }
        .hero-inspiration-caption{
          flex-shrink:0; padding:7px 8px 8px; text-align:center;
          font-size:9px; letter-spacing:0.14em; text-transform:uppercase;
          color:#8b877a; background:#0B0B0C; border-top:1px solid #2a2a26;
        }
